...
fit('', async () => {
  ...
  ///////////////////////////////////////////////////////////
  // SENDING MONEY WITH LEDGER
  // const b = new Browseth('https://mainnet.infura.io/mew');
  // b.wallet = new Browseth.Wallets.Offline(b.rpc, new Browseth.Signers.Ledger());
  // const account = await b.wallet.account();
  // console.log(account);
  // const balance = Browseth.Units.weiToEther(
  //   await b.rpc.send('eth_getBalance', account, 'latest'),
  // );
  // // const tx = await b.rpc.send('net_version');
  // console.log(balance);
  // const tx = await b.wallet.send({
  //   to: '0x90a1a79229c1058564b3c05177cff9c2661409f3',
  //   gasPrice: Browseth.Units.gweiToWei('3'),
  //   value: Browseth.Units.etherToWei('0.1'),
  // });
  // console.log(tx);
  ///////////////////////////////////////////////////////////
});
