...
test('', async () => {
  ...
  // b.wallet = new Wallets.Online(b.rpc);

  const signerWallet = new Wallets.Offline(
    b.rpc,
    new Signers.PrivateKey(
      Buffer.from(
  ...
  // await b.wallet.send({
  //   to: await signerWallet.account(),
  //   value: '0x' + (1000000000000).toString(16),
  // });

  b.wallet = signerWallet;
  console.log(
    await b.rpc.send('eth_getTransactionCount', await b.w.account(), 'latest'),
  );
  console.log(
    await b.wallet.send({
      // to: '0x0123401234012340123401234012340123401234',
      // value: '0x1',
      // gasPrice: '0x11',
      // data : '0x00',
      // chainId: 1,
  ...
  // const ledger = new Signers.Ledger();
