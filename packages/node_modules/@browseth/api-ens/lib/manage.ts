...
//   private client: StandardNodeMethods;

//   constructor(client: StandardNodeMethods, public strict = false) {
//     this.client = client;
...
//     SimpleHashRegistrar.assertIsValidLabel(label);
...
//     labels.forEach(SimpleHashRegistrar.assertIsValidLabel);
...
//   ) {
//     SimpleHashRegistrar.assertIsValidLabel(label);
//     chaff.forEach(SimpleHashRegistrar.assertIsValidLabel);
